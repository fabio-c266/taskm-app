...
import 'package:tasksm_app/components/loading.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  bool _findTaskByTitle(String title) {
    return _userTasks.any((task) => task.title == title);
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          ...
          body: _isLoading ? const Loading() : _getHomeBody(),
